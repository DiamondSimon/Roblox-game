local E={StartingScrap=0,StartingCores=0,IncomePerLevel=0.06,CurrencyLimit=1e12,
...
E.Upgrades={
 Income={Name="Income efficiency",Branch="OPERATIONS",Base=240,Growth=2.1,Max=10,Description="+6% of base machine income per level."},
 Speed={Name="Walking speed",Branch="MOVEMENT",Base=360,Growth=1.7,Max=4,Description="+0.5 stud/sec walking. Maximum 18."},
 Carry={Name="Carrying efficiency",Branch="MOVEMENT",Base=420,Growth=1.75,Max=4,Description="+0.5 stud/sec carrying. Maximum 14."},
 Floors={Name="Additional floor",Branch="YARD",Base=3500,Growth=3,Max=3,Description="Build a floor with eight additional machine spots and stairs."},
}
...
function E.rebirthCost(count) return math.floor(25000*2.5^math.min(count,10)) end
