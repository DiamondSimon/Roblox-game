...
function World.part(parent,name,size,pos,color,material)
 local part=Instance.new("Part");part.Name=name;part.Size=size;part.Position=pos;part.Color=color;part.Material=material or Enum.Material.Metal;part.Anchored=true;part.Parent=parent;return part
end
local Machines={}
