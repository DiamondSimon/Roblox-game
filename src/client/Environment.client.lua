...
local function shredder(part) if part:IsA("BasePart") then shredders[part]=part.CFrame end end
...
Run.Heartbeat:Connect(function(dt)
 ...
 for part,cf in pairs(shredders) do
  if part.Parent and camera and (part.Position-camera.CFrame.Position).Magnitude<180 then part.CFrame=cf*CFrame.Angles(0,0,elapsed*5) end
 end
