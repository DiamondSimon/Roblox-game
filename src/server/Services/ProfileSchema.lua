...
function Schema.migrate(d)
 assert(d.SchemaVersion==1 or d.SchemaVersion==2 or d.SchemaVersion==3 or d.SchemaVersion==4 or d.SchemaVersion==5,"Unsupported schema")
...
function Schema.fresh(uid)
 return {SchemaVersion=5,Rewards={Codes={},Milestones={}},Pets={Owned={},Equipped=""},Scrap=E.StartingScrap,LifetimeScrap=0,Cores=E.StartingCores,
