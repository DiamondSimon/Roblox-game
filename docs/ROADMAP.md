...
Next: complete two-player physics/stair/streaming and phone layout checks; gather eight-player contention and pacing feedback; tune economy and slap frequency; strengthen movement auditing; audition/improve the bundled slap audio and tune the new pet sinks. Persistent stored-machine theft, fusion and security systems are separate future scope.
